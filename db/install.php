...
function xmldb_local_mmu_rise_reportsdash_reports_install() {
    ...
    if (!$DB->record_exists('block_reportsdash_extrep', array('classname' =>'mmu_rise_student_points_report' ))) {

        $externalreport = new \stdClass();
        $externalreport->namespace = "\local_mmu_rise_reportsdash_reports\\reports";
        $externalreport->classpath = "\local_mmu_rise_reportsdash_reports\\reports\\mmu_rise_student_points_report";
        $externalreport->classname = "mmu_rise_student_points_report";
    ...
    // Coursework Settings Amendments report
    if (!$DB->record_exists('block_reportsdash_extrep', array('classname' =>'mmu_rise_student_points_breakdown_report' ))) {

        $externalreport = new \stdClass();
        $externalreport->namespace = "\local_mmu_rise_reportsdash_reports\\reports";
        $externalreport->classpath = "\local_mmu_rise_reportsdash_reports\\reports\\mmu_rise_student_points_breakdown_report";
        $externalreport->classname = "mmu_rise_student_points_breakdown_report";
